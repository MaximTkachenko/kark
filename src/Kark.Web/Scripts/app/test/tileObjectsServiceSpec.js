describe("tileObjectsService", function () {

    describe("getObjectItemId", function () {

        it("should produce correct tile object id", function () {
    ...
    describe("applyChanges", function () {
        ...
        it("should create tile objects for each unique object on tile [ROAD, TOWN, FIELD]", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_8",
                metadata: {
        ...
        it("should create tile objects for each unique object on tile [CHURCH, FIELD, ROAD]", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_8",
                metadata: {
        ...
        it("throws error in case of call the method for the same tile twice", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_8",
                metadata: {
        ...
        it("should set proper slot count for church object", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_3",
                metadata: {
        ...
        it("should update slot count for church when new tile has beed connected", function () {
            var obj = tileObjectsService();
            var fakeTile1 = {
                uid: "tile_3",
                metadata: {
        ...
        it("should connect tile objects for connected tiles properly", function () {
            var obj = tileObjectsService();
            var fakeTile1 = {
                uid: "tile_10",
                angle: 0,
        ...
        it("should connect tile objects for connected tiles properly if current tile has angle 180", function () {
            var obj = tileObjectsService();
            var fakeTile1 = {
                uid: "tile_10",
                angle: 0,
        ...
        it("should connect tile objects for connected tiles properly [COMPLEX CASE]", function () {
            var obj = tileObjectsService();
            var fakeTile1 = {
                uid: "tile_10",
                angle: 0,
    ...
    describe("setOwnerForObject", function () {

        it("should set owner for object", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_8",
                metadata: {
        ...
        it("should throw error in case of call the method twice for the same object", function () {
            var obj = tileObjectsService();
            var fakeTile = {
                uid: "tile_8",
                metadata: {
